...
public class AccountsController {
    ...
    @Autowired
    public AccountsController(IAccountsService iAccountsService, DefaultAccountConfigDto defaultAccountConfigDto, JavaPathDto javaPathDto,Environment environment)
    {
        this.iAccountsService = iAccountsService;
        this.defaultAccountConfigDto = defaultAccountConfigDto;
        this.javaPathDto = javaPathDto;
